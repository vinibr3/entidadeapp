...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  // Configura o state para a página de login
  .state('login',{
    url: '/login',
  ...
  .state('tab.carteirinha', {
    url: '/carteirinha',
    views: {
      'tab-carteirinha': {
        templateUrl: 'templates/tab-carteirinha.html',
        controller: 'CarteirinhaCtrl'
      }
    }
  });
